...
class Interface{
    ...
    static addTask(){
        ...
        const projectObject = _localStorage_js__WEBPACK_IMPORTED_MODULE_2__["default"].getSavedProjectList()
        ...
        if(_localStorage_js__WEBPACK_IMPORTED_MODULE_2__["default"].getSavedProjectList().getProject(projectName).taskListContains(taskTitle)){
        ...
        _localStorage_js__WEBPACK_IMPORTED_MODULE_2__["default"].setTaskIndex(projectName,taskTitle,projectObject.getTaskList().length);
    ...
    static updateTask(taskName,projectObj,editForm){
        ...
        if(newDate === ''){
            _localStorage_js__WEBPACK_IMPORTED_MODULE_2__["default"].setTaskDate(projectObj.getName(),taskObj.getTaskName(),newDate);
        }
        else{
            _localStorage_js__WEBPACK_IMPORTED_MODULE_2__["default"].setTaskDate(projectObj.getName(),taskObj.getTaskName(),(0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(newDate),'dd/MM/yyyy'));
            _localStorage_js__WEBPACK_IMPORTED_MODULE_2__["default"].updateToday();
            _localStorage_js__WEBPACK_IMPORTED_MODULE_2__["default"].updateUpcoming();
        }
        _localStorage_js__WEBPACK_IMPORTED_MODULE_2__["default"].setTaskDetails(projectObj.getName(),taskObj.getTaskName(),newDetails);
        _localStorage_js__WEBPACK_IMPORTED_MODULE_2__["default"].renameTask(projectObj.getName(),taskObj.getTaskName(),newName);
        // Reset the interface.
        Interface.clearTaskList();
    ...
    updateToday(){
        ...
        this.projectList.forEach((project) => {
            ...
            todayTasks.forEach((task)=>{
                const newTaskObj = new _task_js__WEBPACK_IMPORTED_MODULE_1__["default"](task.getTaskName(), task.getDate(), task.getDetails());
