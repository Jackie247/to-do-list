...
export default class Interface {
  ...
  static addTask() {
    ...
    const projectObject =
      LocalStorage.getSavedProjectList().getProject(projectName);
  ...
  static handleTaskEvents(e) {
    ...
    const projectObject =
      LocalStorage.getSavedProjectList().getProject(project);
    if (e.target.classList.contains("bi-x-circle")) {
  ...
  static updateTask(taskName, projectObj, editForm) {
    ...
    LocalStorage.setTaskDetails(
      projectObj.getName(),
      taskObj.getTaskName(),
      newDetails
    );
    LocalStorage.renameTask(
      projectObj.getName(),
      taskObj.getTaskName(),
      newName
    );
