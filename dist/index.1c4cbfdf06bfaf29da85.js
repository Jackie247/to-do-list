...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/NotoSerif-Regular.ttf */ "./src/assets/NotoSerif-Regular.ttf"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_1___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/select.png */ "./src/assets/select.png"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_2___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/alex-shutin-kKvQJ6rK6S4-unsplash.webp */ "./src/assets/alex-shutin-kKvQJ6rK6S4-unsplash.webp"), __webpack_require__.b);
...
document.addEventListener('DOMContentLoaded', _interface_js__WEBPACK_IMPORTED_MODULE_1__["default"].displayHome);
...
class Interface {
  ...
  static loadSavedProjects() {
    _localStorage_js__WEBPACK_IMPORTED_MODULE_2__["default"].getSavedProjectList()
      .getProjects()
      .forEach((project) => {
        if (
          project.name !== "Inbox" &&
  ...
  static loadTasks(projectName) {
    const savedProjectList = _localStorage_js__WEBPACK_IMPORTED_MODULE_2__["default"].getSavedProjectList();
  ...
  static addProjectToList() {
    ...
    if (_localStorage_js__WEBPACK_IMPORTED_MODULE_2__["default"].getSavedProjectList().projectListContains(projectName)) {
      addProjectTitleInput.value == "";
      alert("Project already exists");
      return;
    }
    _localStorage_js__WEBPACK_IMPORTED_MODULE_2__["default"].addProject(new _project_js__WEBPACK_IMPORTED_MODULE_0__["default"](projectName));
  ...
  static deleteProject(projectName, button) {
    ...
    _localStorage_js__WEBPACK_IMPORTED_MODULE_2__["default"].deleteProject(projectName);
    Interface.clearProjectList();
    Interface.loadSavedProjects();
  }
  ...
  static openToday() {
    _localStorage_js__WEBPACK_IMPORTED_MODULE_2__["default"].updateToday();
    Interface.openProject("Today", this);
  }
  static openUpcoming() {
    _localStorage_js__WEBPACK_IMPORTED_MODULE_2__["default"].updateUpcoming();
  ...
  static addTask() {
    ...
    const projectObject =
      _localStorage_js__WEBPACK_IMPORTED_MODULE_2__["default"].getSavedProjectList().getProject(projectName);
    ...
    if (
      _localStorage_js__WEBPACK_IMPORTED_MODULE_2__["default"].getSavedProjectList()
        .getProject(projectName)
        .taskListContains(taskTitle)
    ) {
      alert("Task names must be different");
      return;
    }
    // Adds the task object to localStorage
    _localStorage_js__WEBPACK_IMPORTED_MODULE_2__["default"].addTask(projectName, new _task_js__WEBPACK_IMPORTED_MODULE_1__["default"](taskTitle));
    // If task date is not provided, we just set an empty task date for the task object
    if (taskDate === "") {
      _localStorage_js__WEBPACK_IMPORTED_MODULE_2__["default"].setTaskDate(projectName, taskTitle, taskDate);
    } else {
      // If task is provided, we can set the task object date
      // to a formatted string.
      const newTaskDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(taskDate), "dd/MM/yyyy");
      _localStorage_js__WEBPACK_IMPORTED_MODULE_2__["default"].setTaskDate(projectName, taskTitle, newTaskDate);
      // Update both Today and Upcoming projects if the date is within these ranges
      _localStorage_js__WEBPACK_IMPORTED_MODULE_2__["default"].updateToday();
      _localStorage_js__WEBPACK_IMPORTED_MODULE_2__["default"].updateUpcoming();
    }
    _localStorage_js__WEBPACK_IMPORTED_MODULE_2__["default"].setTaskDetails(projectName, taskTitle, taskDetails);
    _localStorage_js__WEBPACK_IMPORTED_MODULE_2__["default"].setTaskProjectParent(projectName, taskTitle);
    _localStorage_js__WEBPACK_IMPORTED_MODULE_2__["default"].setTaskIndex(
      projectName,
      taskTitle,
      projectObject.getTaskList().length
    );
    // Create task to display on interface
    const taskObject = _localStorage_js__WEBPACK_IMPORTED_MODULE_2__["default"].getSavedProjectList()
      .getProject(projectName)
      .getTask(taskTitle);
  ...
  static deleteTask(task) {
    const openProject = document.getElementById(
      "project-tasks-title"
    ).textContent;
    ...
    if (
      openProject === "Inbox" ||
      openProject === "Today" ||
      openProject === "Upcoming"
    ) {
      _localStorage_js__WEBPACK_IMPORTED_MODULE_2__["default"].deleteTask(taskProjectParent, taskName);
    }
    _localStorage_js__WEBPACK_IMPORTED_MODULE_2__["default"].deleteTask(openProject, taskName);
    Interface.clearTaskList();
  ...
  static handleTaskEvents(e) {
    ...
    const projectObject =
      _localStorage_js__WEBPACK_IMPORTED_MODULE_2__["default"].getSavedProjectList().getProject(project);
    if (e.target.classList.contains("bi-x-circle")) {
  ...
  static updateTaskCompleted(task, projectObj) {
    ...
    const currOpenProject = document.getElementById(
      "project-tasks-title"
    ).textContent;
    ...
    if (taskObj.getChecked()) {
      _localStorage_js__WEBPACK_IMPORTED_MODULE_2__["default"].setTaskChecked(projectObj.getName(), taskName, false);
    } else {
      _localStorage_js__WEBPACK_IMPORTED_MODULE_2__["default"].setTaskChecked(projectObj.getName(), taskName, true);
    }
  }
  ...
  static renderTaskDetails(task, projectObj) {
    ...
    taskDetails.setAttribute(
      "placeholder",
      "Details: e.g shopping, gym, deadlines"
    );
  ...
  static updateTask(taskName, projectObj, editForm) {
    ...
    if (newDate === "") {
      _localStorage_js__WEBPACK_IMPORTED_MODULE_2__["default"].setTaskDate(
        projectObj.getName(),
        taskObj.getTaskName(),
        newDate
      );
      ...
      _localStorage_js__WEBPACK_IMPORTED_MODULE_2__["default"].setTaskDate(
        projectObj.getName(),
        taskObj.getTaskName(),
        (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(newDate), "dd/MM/yyyy")
      );
      _localStorage_js__WEBPACK_IMPORTED_MODULE_2__["default"].updateToday();
      _localStorage_js__WEBPACK_IMPORTED_MODULE_2__["default"].updateUpcoming();
    }
    _localStorage_js__WEBPACK_IMPORTED_MODULE_2__["default"].setTaskDetails(
      projectObj.getName(),
      taskObj.getTaskName(),
      newDetails
    );
    _localStorage_js__WEBPACK_IMPORTED_MODULE_2__["default"].renameTask(
      projectObj.getName(),
      taskObj.getTaskName(),
      newName
    );
...
class Project {
  ...
  getTodaysTasks() {
    return this.taskList.filter((task) => {
      return (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(task.returnDateFormatted())));
    });
  }
  getUpcomingTasks() {
    return this.taskList.filter((task) => {
      const taskDueDate = new Date(task.returnDateFormatted());
      return (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(taskDueDate), 1));
    });
  }
}
  ...
  deleteProject(projectName) {
    ...
    if (this.projectListContains(projectName)) {
      this.projectList.splice(
        this.projectList.indexOf(this.getProject(projectName)),
        1
      );
    }
    return;
  ...
  updateToday() {
    ...
    this.projectList.forEach((project) => {
      ...
      todayTasks.forEach((task) => {
        const newTaskObj = new _task_js__WEBPACK_IMPORTED_MODULE_1__["default"](
          task.getTaskName(),
          task.getDate(),
          task.getDetails()
        );
      ...
      this.getProject("Upcoming")
        ...
        .sort((taskOne, taskTwo) =>
          (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(
            (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(taskOne.returnDateFormatted())),
            (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(taskTwo.returnDateFormatted()))
          )
        )
    );
  }
...
/***/ "./src/assets/NotoSerif-Regular.ttf":
/*!******************************************!*\
  !*** ./src/assets/NotoSerif-Regular.ttf ***!
  \******************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "NotoSerif-Regular.ttf";

/***/ }),

/***/ "./src/assets/alex-shutin-kKvQJ6rK6S4-unsplash.webp":
/*!**********************************************************!*\
  !*** ./src/assets/alex-shutin-kKvQJ6rK6S4-unsplash.webp ***!
  \**********************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "alex-shutin-kKvQJ6rK6S4-unsplash.webp";
